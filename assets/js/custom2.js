(function() {
	...
	// Начало движения элемента за мышью
	...
	// 	var yPosition = e.clientY - parentPosition.y - (picture.clientHeight / 2) + 500;
	...
	// 	var yPos = 0; 
	// 	while (element) {
	// 	 if (element.tagClass == "double-mask") {
	...
	// Конец движения элемента за мышью
